...
% \item  Reinforcement Learning with Human Feedback
\item  Training dynamics of modern machine learning mdoels
...
% \begin{enumerate}
%   \item Precise training dynamics of Adam for Mulit-layer Neural Network
%   \item Alignment of LLM via Markov Chain
% \end{enumerate}
\subsection*{Preprint}
\begin{enumerate}
