...
Takuya Koriyama\\
\textit{arXiv:2506.21527, 2025, major revision at Stochastic Processes and their Applications}
...
% \begin{enumerate}
%   \item Direct alignment from Pairwise comparison: a markov chain approach\\
%   Takuya Koriyama and Tengyuan Liang
%   % \item Precise training dynamics of adaptive optimizer for Multi-layer Neural Network\\
%   % joint work with Kazuma Sawaya, Qiyang Han, and Masaaki Imaizumi  
% \end{enumerate}
